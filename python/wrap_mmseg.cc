...
g++ -shared -fPIC ye_mmseg.cc -o ye_mmseg.so -lboost_python -I/usr/include/python2.6 -I/usr/local/include/mmseg
...
BOOST_PYTHON_MODULE(mmseg)
{
  class_<SegmentedToken, boost::noncopyable > ("SegmentedToken", "This is a SegmentedToken project python extend", init<>())
            ...
            .def("token_type", &SegmentedToken::token_type, return_value_policy<copy_const_reference>());
